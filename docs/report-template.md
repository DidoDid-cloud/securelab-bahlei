...
- Гілка: `lab/1-system`.
- Фінальний тег: `TODO` (буде встановлено після merge у main).
- Commit hash: `TODO` (буде зафіксовано після тегування).
...
`TODO` — сформулюємо після завершення T-08 і Git-циклу.
